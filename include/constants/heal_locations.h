...
enum {
    HEAL_LOCATION_NONE,
    HEAL_LOCATION_MOONCREST_TOWN_PLAYER_HOUSE,
    ...
    HEAL_LOCATION_PETALBURG_CITY_2,
    HEAL_LOCATION_MOONCREST_TOWN,
    HEAL_LOCATION_VALLEY_TOWN,
    HEAL_LOCATION_VALLEY_TOWN_POKECENTER,
    NUM_HEAL_LOCATIONS
};
