...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(MAP_LITTLEROOT_TOWN), MAP_NUM(MAP_LITTLEROOT_TOWN), HEAL_LOCATION_MOONCREST_TOWN_PLAYER_HOUSE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_LITTLEROOT_TOWN:
        return FlagGet(FLAG_VISITED_MOONCREST_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_MOONCREST_TOWN;
